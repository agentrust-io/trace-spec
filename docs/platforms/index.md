...
|---|---|---|
| [Bernstein](bernstein.md) | `software-only` | An Ed25519-signed record over a hash-chained run journal, with a deterministic coordination sequence a verifier can re-derive. No hardware assurance; Level 0 |
