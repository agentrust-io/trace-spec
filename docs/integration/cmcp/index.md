...
1. Evaluates Cedar policy inside a hardware TEE (AMD SEV-SNP, Intel TDX, NVIDIA H100)
1. Measures the policy bundle into the TEE before any code runs
1. Signs the TRACE Trust Record with a TEE-bound Ed25519 key
1. Anchors the record in the TRACE transparency registry (optional)
...
| What                                   | Where                                                                                                 |
| -------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| Trust level guarantees                 | [Trust Levels](https://trace.agentrust-io.com/docs/trust-levels/index.md)                             |
| Hardware attestation platforms         | [Platforms overview](https://trace.agentrust-io.com/docs/platforms/index.md)                          |
| Step-by-step cMCP integration tutorial | [Integrating with cMCP](https://trace.agentrust-io.com/docs/tutorials/integrating-with-cmcp/index.md) |
| cMCP source and deployment             | [agentrust-io/cmcp](https://github.com/agentrust-io/cmcp)                                             |
| AGT integration                        | [Integration: AGT](https://trace.agentrust-io.com/docs/integration/agt/index.md)                      |
