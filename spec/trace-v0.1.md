> **Superseded by [TRACE v0.2](trace-v0.2.md).** The profile URI in this document, `tag:agentrust.io,2026:trace-v0.1`, names a domain this project does not control and is invalid under RFC 4151. v0.2 corrects it to `tag:agentrust-io.com,2026:trace-v0.2` and changes nothing else. This document is retained so records already issued under it stay readable; do not implement it for new work.
