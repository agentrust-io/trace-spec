...
| License                  | Apache 2.0 (see [LICENSE](https://trace.agentrust-io.com/spec/LICENSE))      |
...
1. Numbers are serialized in IEEE 754 double-precision format using the shortest decimal representation that round-trips.
1. Strings are serialized as UTF-8; only the characters mandated by RFC 8259 §7 are escaped (U+0022, U+005C, and U+0000–U+001F).
